...
class ResBlock(torch.nn.Module):
    def __init__(self, num_filter, kernel_size=3, stride=0, padding=0, bias=True, activation='prelu', norm=None):
        super(ResBlock, self).__init__()
        m = []
        for i in range(2):
            m.append(ConvBlock(num_filter, num_filter, kernel_size, stride, padding, activation, norm=None))
...
class UpSampleX2(torch.nn.Module):
    def __init__(self, num_filter, kernel_size=3, stride=2, padding=1, bias=True, activation='prelu', norm=None):
        super(UpSampleX2, self).__init__()
        self.down_conv = DeconvBlock(num_filter, num_filter, kernel_size, stride, padding, activation, norm=None)
